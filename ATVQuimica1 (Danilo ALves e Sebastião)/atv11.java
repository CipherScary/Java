...
public class atv11 { // Declaração da classe chamada atv11
    public static void main(String[] args) { // Método principal do programa
        ...
        System.out.print("Digite a aceleração desejada em m/s²: "); // Exibe uma mensagem solicitando a aceleração ao usuário
        double aceleracao = scanner.nextDouble(); // Lê a aceleração fornecida pelo usuário e armazena na variável 'aceleracao'
        
        double forca = massa * aceleracao; // Calcula a força usando a fórmula: Força = Massa × Aceleração
        
        System.out.println("A força necessária é " + forca + " N."); // Exibe o resultado da força calculada
